          ...
          channels.map((ch) => {
            ...
            return (
              <div
                ...
                className={`group flex h-9 w-full min-w-0 max-w-full items-center gap-2 px-3 sm:w-40 rounded-lg cursor-pointer border text-xs font-semibold transition select-none ${
                  isSelected
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  {ch.username && <span className="text-[10px] text-blue-100/80 font-normal">@{ch.username}</span>}
                </div>
                ...
                <button
                  ...
                  className="ml-1 p-1 text-blue-100/70 hover:text-red-200 rounded transition opacity-100 sm:opacity-0 sm:group-hover:opacity-100"
                >
