        ...
        <div className="grid grid-cols-[minmax(0,1fr)_auto_auto] items-center gap-2 sm:flex sm:flex-wrap">
          ...
          {botStatus?.connected ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="min-w-0 flex items-center gap-1.5 px-3 py-1.5 bg-emerald-950/40 text-emerald-300 border border-emerald-500/30 hover:bg-emerald-900/40 rounded-lg text-xs font-semibold transition"
            >
            ...
            <div className="min-w-0 flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 text-slate-400 border border-slate-700 rounded-lg text-xs font-medium">
