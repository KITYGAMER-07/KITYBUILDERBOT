  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl max-w-lg w-full p-5 space-y-5 shadow-2xl animate-in fade-in zoom-in-95">
        ...
        <div className="p-3.5 bg-gradient-to-r from-blue-950/60 to-indigo-950/60 border border-blue-500/30 rounded-xl flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full sm:w-auto shrink-0 h-10 flex items-center justify-center gap-1.5 px-4 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-bold shadow-md shadow-blue-600/30 transition active:scale-95"
          >
