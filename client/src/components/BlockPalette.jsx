...
const BLOCK_TYPES = [
  {
    ...
    items: [
      ...
      { type: 'footer', label: 'Footer Note', icon: AlignLeft, color: 'text-slate-400', defaultData: { text: '© 2026 RICH STUDIO. All rights reserved.' } },
