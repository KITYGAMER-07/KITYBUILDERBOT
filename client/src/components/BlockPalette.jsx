...
import {
  ...
  Code2, Pi, Layers, LayoutGrid, Image, Video, Sparkles,
...
const BLOCK_TYPES = [
  {
    ...
    items: [
      ...
      { type: 'footer', label: 'Footer Note', icon: AlignLeft, color: 'text-slate-400', defaultData: { text: '© 2026 NovaEsp. All rights reserved.' } },
  ...
  },
  {
    ...
    items: [
      { type: 'slideshow', label: 'Slideshow Carousel', icon: Layers, color: 'text-blue-400', defaultData: { items: [{ url: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=800&q=80', caption: 'Slide 1' }, { url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80', caption: 'Slide 2' }] } },
      { type: 'collage', label: 'Collage Grid', icon: LayoutGrid, color: 'text-teal-400', defaultData: { items: [{ url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80' }, { url: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&q=80' }] } },
      { type: 'photo', label: 'Photo', icon: Image, color: 'text-sky-400', defaultData: { url: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=800&q=80', caption: 'Photo caption' } },
      { type: 'video', label: 'Video', icon: Video, color: 'text-rose-400', defaultData: { url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', caption: 'Video caption' } },
      { type: 'animation', label: 'GIF Animation', icon: Sparkles, color: 'text-amber-400', defaultData: { url: 'https://media.giphy.com/media/26ufdipQqU2lhNA4g/giphy.gif', caption: 'GIF caption' } },
      { type: 'audio', label: 'Audio / Music', icon: Music, color: 'text-indigo-400', defaultData: { url: 'https://example.com/audio.mp3', title: 'Track Name', performer: 'Artist' } },
      { type: 'voice', label: 'Voice Note', icon: Mic, color: 'text-red-400', defaultData: { url: 'https://example.com/voice.ogg', duration: 12 } }
    ]
  },
  {
