...
export const CollageEditor = ({ block, onChange }) => {
  const items = block.items || [
    { url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80', caption: 'Photo 1' },
    { url: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&q=80', caption: 'Photo 2' }
  ];
