                ...
                <div key={btnIdx} className="bg-slate-950 border border-slate-800 rounded p-2 space-y-2">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 bg-slate-900 border border-slate-700 rounded px-2.5 py-1 text-xs text-white focus:outline-none focus:border-blue-500 font-medium"
                    />

                    <select
                      value={btn.type || 'url'}
                      onChange={(e) => updateButton(rowIdx, btnIdx, 'type', e.target.value)}
                      className="bg-slate-900 border border-slate-700 text-xs text-slate-300 rounded px-2 py-1 focus:outline-none focus:border-blue-500"
                    >
